...
export interface ApiDesignDesign extends Schema.CollectionType {
  ...
  attributes: {
    ...
    avatar_img: Attribute.Media<'images'> & Attribute.Required;
    images: Attribute.Media<'images', true> & Attribute.Required;
    long_description1: Attribute.Text & Attribute.Required;
    long_description2: Attribute.Text & Attribute.Required;
...
export interface ApiEnableBuyDesignEnableBuyDesign extends Schema.SingleType {
  ...
  info: {
    singularName: 'enable-buy-design';
    pluralName: 'enable-buy-designs';
    displayName: 'enable-buy-design';
    description: '';
  };
  options: {
    draftAndPublish: true;
  ...
  attributes: {
    ...
    publishedAt: Attribute.DateTime;
    createdBy: Attribute.Relation<
      'api::enable-buy-design.enable-buy-design',
      'oneToOne',
      'admin::user'
    > &
      Attribute.Private;
